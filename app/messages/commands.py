...
BROADCAST_CONTRACT = """
привіт! я з відбіркової комісії ФІОТ. ти пройшов на дві спеціальності, в обох ти до наказу. 
додайся будь ласка до чату абітурієнт ФІОТ https://t.me/abit_fict  та відпишись у гілку про питання, тебе там шукають)
потрібно буде написати відмову на одну зі спеціальностей
"""
